...
This project publishes no email address. GitHub gives one private channel between a reader
...
The form carries the word security in its title, because GitHub built it for a weakness
report. A conduct report is welcome there as well.

If the report is about the maintainer, send it to GitHub instead, at
